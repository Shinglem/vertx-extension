...
import io.github.shinglem.util.consoletable.converter.PlainConsoleConverter;
import io.github.shinglem.util.consoletable.parser.JsonParser;
...
public class PrettyTable {
    ...
    public PrettyTable addRows(final Collection<Object[]> rows) {
